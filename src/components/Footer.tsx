...
const Footer = () => {
  return (
    <FlowbiteFooter container className="bg-gray-50 dark:bg-gray-900">
        ...
        <div className="grid w-full justify-between sm:flex sm:justify-between md:flex md:grid-cols-1">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-4 max-w-lg text-gray-600 dark:text-gray-400">
              Creating timeless terrazzo surfaces that blend art with
              functionality. We specialize in high-quality flooring,
              countertops, and custom terrazzo solutions.
            </p>
          </div>
